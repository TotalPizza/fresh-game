...
export default function BuildMenu(props: {show: boolean, toggle_build_menu: () => void, placing_building: (item: BuildItem) => void}) {    
    return (
        <div className={styles.menu} hidden={!props.show}>
            ...
            <Image className={styles.building_icon_frame_hover} onClick={()=>props.placing_building({building: BuildType.Mill, src:'/images/mill.png', width: 300, height: 300})} alt={"mill_icon_frame_hover"} src='/images/frame_hovered.png' width={109} height={109}/>
