...
export default function BuildMenu(props: {building_status: boolean[],show: boolean, toggle_build_menu: () => void, placing_building: (item: BuildItem) => void}) {    
    return (
        <div className={styles.menu} hidden={!props.show}>
            ...
            <BuildingIcon position={{top: -150, left: -320}} icon_src={"/images/town_hall_icon"} building={{src: '/images/town_hall_white.png', width: 417, height: 249, building: BuildType.TownHall}} building_status={props.building_status[0]} placing_building={props.placing_building}/>
            <BuildingIcon position={{top: -150, left: -100}} icon_src={"/images/nostra_mill_icon"} building={{src: '/images/mill_white.png', width: 300, height: 300, building: BuildType.Mill}} building_status={props.building_status[1]} placing_building={props.placing_building}/>
        </div>
    )
}